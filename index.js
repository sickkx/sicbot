...
const { sicmenu } = require('./src/toinmenu')
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5521968221650:+55 (21) 96822-1650\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌄1�7 Calmaer opoha to fazendo ⌄1�7',
				success: '✔️ Sucesso ✔️',
                                levelon: '❄1�7 ✄1�7 ❄1�7 *habilitar Level*',
				leveloff: ' ❄1�7 X ❄1�7  *desabilitar Level*',
				levelnoton: '❄1�7 X ❄1�7 *level não ativo*',
				levelnol: '*Pqp kskst level* 0 ',
				error: {
					stick: '[❗] Falha, ocorreu um erro ao converter a imagem em um adesivo ❄1�7',
					Iv: '❄1�7 Link inválido ❄1�7'
				},
				only: {
					group: '[❗] Este comando só pode ser usado em grupos! ❄1�7',
					ownerG: '[❗] Este comando só pode ser usado pelo grupo proprietário! ❄1�7',
					ownerB: '[❗] Este comando só pode ser usado pelo Toin! ❄1�7',
					admin: '[❗] Este comando só pode ser usado por administradores de grupo! ❄1�7',
					Badmin: '[❗] Este comando só pode ser usado quando o bot se torna administrador! ❄1�7',
                                        daftarB: `┄1�7┄1�7 「REGISTRE-SE〄1�7 ┄1�7┄1�7\nOlá como!\nVocê não está registrado no banco de dados, \n\nComando : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar Toin|18`,
				}
			}
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5521968221650@s.whatsapp.net'
                        /******ApiKey Input******/
            ...
            try {
                ...
                if (requiredXp <= getLevelingXp(sender)) {
                    ...
                    await reply(`*〄1�7 LEVEL UP 〄1�7*\n\n➄1�7 *Nome*: ${sender}\n➄1�7 *XP*: ${getLevelingXp(sender)}\n➄1�7 *Level*: ${getLevel} -> ${getLevelingLevel(sender)}\n\nParabéns!! 🎉🎉`)
                }
            } catch (err) {
                console.error(err)
            }
...
case 'timer':
		...
		client.sendMessage(from, bahasa(prefix, sender), text, {quoted: mek})
				break
				case 'sicmenu':
					client.sendMessage(from, sicmenu(prefix, sender), text, {quoted: mek})
							break
							case 'menuadmin':
